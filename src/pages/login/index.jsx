        ...
        <LoginBox>
          <TabList>
            {
              pageItemList.map((item, index) => {
                return (
                  <Fragment key={index}>
                    <TabListItem className={ item.active ? 'active' : ''} onClick={() => {this.handleTabListItemClick(item.url)}}>
                      {item.tag}
                    </TabListItem>
          ...
          <TabPageBox 
              ...
              <Input
                ...
                endAdornment={
                  <InputAdornment position="end">
                    ...
                    >
                    <i className="iconfont" style={{fontSize: '20px'}} dangerouslySetInnerHTML={{__html: this.state.showPassword ? '&#xe724;' : '&#xe723;'}}
                    >
                    </i>
                    </IconButton>
                  </InputAdornment>
            ...
            <FormControl style={{width: '200px'}}>
              <Button variant="contained" color="#426F42"
